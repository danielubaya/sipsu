...
<li class="breadcrumb-item active" aria-current="page">Replanning</li>
@endsection
    ...
    <div class="card" style="width:100%">
        <div class="card-header pb-0 pd-t-25">
            <div class="d-flex justify-content-between " >
                <h2 class="card-title mg-b-0">Daftar Replanning</h2>				
            </div>
            <p class="tx-12 text-muted mb-0 dark-orange" >
                Perumahan-perumahan yang dalam proses Replanning
            </p>
        </div>
        <div class="card-body">
