...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('dokumen/peta', [App\Http\Controllers\PerumahanController::class, 'peta']);	

    Route::get('dokumen/logout', [App\Http\Controllers\Auth\LoginController::class, 'logout']);
